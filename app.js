...
function renderMessage(text, role, imageData = null, savedSources = null) {
  ...
  if (imageData) {
    ...
    img.src = imageData;
    img.loading = "lazy";
    // Apply specific class for AI generated images vs user thumbnails
    img.className = role === "leocore" ? "ai-generated-image" : "chat-img-thumb"; 
    img.onclick = () => openFullscreenPreview(imageData);
    el.appendChild(img);
    
    // Add a small "Generated by LeoCore" badge if you want that premium feel
    if (role === "leocore") {
        const badge = document.createElement("div");
        badge.className = "image-badge";
        badge.innerHTML = `<svg ...> AI Gen`;
